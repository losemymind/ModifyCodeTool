...
****************************************************************************/
#ifndef FOUNDATIONKIT_IOSPLATFORM_HPP
#define FOUNDATIONKIT_IOSPLATFORM_HPP
...
#endif // #if defined(TARGET_OS_IOS) && (TARGET_OS_IOS == 1)
#endif // END OF FOUNDATIONKIT_IOSPLATFORM_HPP